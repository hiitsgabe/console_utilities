"""NHL 05 PS2 Patcher screen — NHL 05 (PS2) roster update.
...
class NHL05PS2PatcherScreen:
    ...
    def _get_items(self, state, settings):
        ...
        """
        nhl = state.nhl05_ps2_patcher
        provider = (settings or {}).get("nhl05_provider", "espn")
        ...
        if provider == "nhl":
            ...
            if season_idx is not None:
                ...
                if 0 <= visible_idx < len(item_rects):
                    ...
                    season = state.nhl05_ps2_patcher.selected_season
...
nhl05_ps2_patcher_screen = NHL05PS2PatcherScreen()
