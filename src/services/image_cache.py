...
class ImageCache:
    ...
    def update(self):
        ...
        """
        self._process_queue(self._thumbnail_queue, self._thumbnail_cache, self.MAX_THUMBNAILS)
        self._process_queue(self._hires_queue, self._hires_cache, self.MAX_HIRES)
    ...
    def _process_queue(self, queue: Queue, cache: collections.OrderedDict, max_size: int):
        """Process items from queue into cache, evicting LRU entries if over max_size."""
