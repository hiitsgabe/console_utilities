"""Stat mapping for NHL 05 PS2 patcher.

Maps NHL player stats from ESPN/NHL API to NHL 05's 0-63 attribute scale.
...
class NHL05StatMapper:
    """Maps NHL API player data to NHL 05 PS2 ROM attributes."""
    ...
    def map_player(
        ...
        """Map an ESPN/NHL API Player to NHL 05 player record."""
        ...
        # Weight encoding for NHL 05: raw pounds value (stored as 8-bit)
        ...
        if is_goalie:
            if stats:
                ...
                record.goalie_attrs = NHL05GoalieAttributes(
                    **{
            ...
            if stats:
                ...
                record.skater_attrs = NHL05SkaterAttributes(
                    **{
    ...
    def _map_skater_stats(self, stats: Dict, pos: str) -> NHL05SkaterAttributes:
        """Map real NHL stats to NHL 05 skater attributes (0-63 scale).
    ...
    def _map_goalie_stats(self, stats: Dict) -> NHL05GoalieAttributes:
        """Map real NHL goalie stats to NHL 05 attributes (0-63 scale).
    ...
    def select_roster(
        ...
        """Build NHL 05 roster with proper line structure.
        ...
        # NHL 05 order: goalies first, then forwards, then defense
    ...
    def get_team_slot(self, team_abbrev: str) -> Optional[int]:
        """Get NHL 05 ROM slot for a modern NHL team."""
