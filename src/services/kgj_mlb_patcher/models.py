...
POSITION_TO_BYTE = {
    "P": 0x00, "C": 0x02, "LF": 0x04, "CF": 0x06, "RF": 0x08,
    "3B": 0x0A, "SS": 0x0C, "2B": 0x0E, "1B": 0x10, "DH": 0x12,
    "IF": 0x14, "OF": 0x16,
}
...
class KGJPlayerRecord:
    ...
    # Batter fields
    batter_attrs: KGJBatterAttributes = field(
        default_factory=KGJBatterAttributes
    )
    batter_appearance: KGJBatterAppearance = field(
        default_factory=KGJBatterAppearance
    )
    ...
    # Pitcher fields
    pitcher_attrs: KGJPitcherAttributes = field(
        default_factory=KGJPitcherAttributes
    )
